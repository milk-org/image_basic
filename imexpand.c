...
static errno_t image_basic_expand_cli()
{
    ...
    {
        basic_expand(data.cmdargtoken[1].val.string, data.cmdargtoken[2].val.string, data.cmdargtoken[3].val.numl,
...
static errno_t image_basic_expand3D_cli()
{
    ...
    {
        basic_expand3D(data.cmdargtoken[1].val.string, data.cmdargtoken[2].val.string, data.cmdargtoken[3].val.numl,
...
errno_t imexpand_addCLIcmd()
{
    ...
    RegisterCLIcommand("imexpand3D", __FILE__, image_basic_expand3D_cli, "expand 3D image",
                       "<image in> <output image> <x factor> <y factor> <z factor>", "imexpand3D im1 im2 2 2 2",
